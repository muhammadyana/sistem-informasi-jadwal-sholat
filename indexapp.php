	...
	<div class="section light-green z-depth-1">
		<div class="row" style="margin-bottom:-15px">
			...
			<div class="col l6 s12 m12 center">
				<h4 class="center ucword"><?PHP echo ucwords($dataMosque->name_of_mosque);  ?></h4>
...
$(window).on('load', function() { // makes sure the whole site is loaded
  ...
  var tesJadwal = function(){
    prayTimes.setMethod('Karachi');
    var date = new Date();
    var latitude = -6.9174639 ;
    var longitude = 107.6191228;
    return prayTimes.getTimes(date, [latitude, longitude], +7);
  };
  var schedule = tesJadwal();
  //console.log(schedule);
//  $("#assholat").html(schedule.asr);
	/**
	 * getUpcomingSchedule
...
//  var jedahWaktu = duration();
  //console.log(jedahWaktu);
